...
public class Aggregate{
	...
	/*public static void input(BufferedReader br, String agg_column, String[] group_columns, String[] header_line, int[] group_count, String function) {
		...
		while(input.hasNext()) {
			...
			for(int i= 0; i<group_columns.length; i++) {
				System.out.print(data[group_count[i]]+",");
			}
			...
			else {System.out.print(data[count]+"\n");}

		}

		/*for(int i= 0; i<group_count.length; i++) {
			System.out.println(group_count[i]+",,,,");
		}*/
	//}
	...
	public static void input(BufferedReader br, String agg_column, String[] group_columns, String[] header_line, int[] group_count, String function) {
		...
		/*System.out.println(occurrences.keySet()+" This is the result of after grouping with group_columns");
		System.out.println(map.values()+" This is the result of function 'sum', sum up all elements in the aggregation column within each group");
		System.out.println(occurrences.values()+" This is the result of function 'count', the number of rows in each group");*/
